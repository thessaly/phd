# Marco teórico (*in progress*)

Con el fin de comprender cómo esta nueva forma de construir tecnología (abierta, colaborativa, descentralizada) interactúa con la manera existente, dominante de producirla (centralizada, de diseño cerrado y asociada al uso de patentes) vamos a utilizar la Perspectiva Multi-Nivel combinada con elementos de la literatura de movimientos sociales para analizar, entre otras cosas, cómo estos grupos movilizan recursos, aprenden lecciones ó elaboran narrativas. También recurrimos a la literatura específica de la cultura colaborativa y open-source para entender estas nuevas formas de construcción de comunidad. Finalmente tomamos de la reciente literatura sobre 'innovación democrática' algunos conceptos para entender cómo estos grupos pueden estar contribuyendo a democratizar el régimen de producción tecnológica actual.
...
Algunos de los principales actores que identificamos dentro de esta nueva forma de producir tecnología presentan características que los acercan a la literatura de movimientos sociales. Según Tarrow (2004) y Tilly (2008) un movimiento social es una forma histórica de acción colectiva, compuesta de tres elementos:

- Una demanda colectiva que desafía las élites o instituciones sociales y abre una controversia sobre recursos, derechos o valores;
- Formas de organizacion ubicadas primariamente en la sociedad civil, con un set de estrategias o repertorios de accion distintos a lo institucional;
- Una forma de accion colectiva sostenida en el tiempo the crea lazos de solidaridad e identidad

Los movimientos sociales, además, son productores de conocimiento (Eyerman y Jamison 1991) ya que toman diversos recursos y los traducen en acción política. Actuan como laboratorios de ideas, formas de organizacion y conocimiento. Su forma de aprender es a través del hacer y reflexionar sobre las propias prácticas, estrategias y formas de organización, produciendo conocimiento que desafía el status quo y favorece la reflexión de la sociedad en su conjunto.
...
**Los movimientos de innovación de base desarrollan estrategias alternativas de produccion de conocimiento**
...
### Innovación democrática y Movimientos de Innovación de Base

Smith y Stirling (2018) identifican cuatro vías a través de las cuales los MIB pueden contribuir al proceso de democratización de la innovación:

**A través de las mismas prácticas internas del procso de innovación**

Las actividades realizadas por los MIB suelen estar basadas en valores, e incluso cuando la motivación de fondo es económica suelen asumir que los valores no pueden ser contradichos (Seyfang et al., 2014). Estas actividades, por lo general marginalizadas de las agendas oficiales, son trabajadas en los MIB en términos de cómo resulta mejor alcanzarlas -repertorios de acción, movilización de recursos-. Este abanico de prácticas y métodos son relevantes a la democratización de la innovación (Smith et al, 2016; Jamison, 2003). Un valor clave de estos movimientos son las prácticas para lograr apoyo y legitimidad local, difundiendo y reflexionando sobre sus intereses y compromisos (Smith et al 2013; Hess, 2007)
...
En este aspecto la contribución es concreta: los MIB generan configuraciones socio-técnicas que permiten la exploración y practica de valores sociales y visiones más democráticas, abriendo espacios para la deliberación. Al no estar influidos por las limitaciones mainstream, los MIB tienen más libertad para explorar diferentes valores y visiones, que incluyen en el proceso de innovación. Generalmente se trata de preocupaciones negadas o marginalizadas -producción local, desarrollo sostenible, trabajo creativo o significativo-. Estos valores y visiones distintas impulsan una innovación diferente, por definición más diversa.

**A través de reforzar los niveles de diversidad**

La diversidad es uno de los aspectos clave de la innovación democrática. Las prácticas y procesos de los MIB contribuyen a aumentar la diversidad social y material de distintas formas:
