...
Fig. 1: Versión 1.0 (Darwin) de RepRap, la impresora 3D autorreplicable basada en Arduino
...
<table>
  <tr>
    <td>Box2: Computadora Industrial Abierta Argentina
...
Fig. 2: EDU-CIAA-NXP, una versión de bajo costo de la CIAA-NXP pensada para la enseñanza universitaria, terciaria y secundaria
...
**Fig. 3: Ejemplo de diagrama esquemático de un cargador de baterías 12V**
...
**Fig 4: ejemplo de circuito impreso**
...
**Fig 5: diseño terminado de circuito impreso (izq.) y especificaciones en formato Gerber, listas para ser leídas por el fabricante (der.)**
...
<table>
  <tr>
    <td>Box3: Open Source Ecology - Global Village Construction Set
...
Fig. 6: El kit incluye un tractor, impresora 3D, cortadora láser, soldadora, aserradero, un horno de panadería, un pulverizador de suelo, una sembradora, un aerogenerador, entre otros (http://opensourceecology.org/gvcs/)
...
Fig. 7: Comparación de costos entre maquinaria agrícola abierta y privativa

Open Source Ecology es una obvia inspiración para otros “makers” y emprendedores, pero además puede brindar lecciones a instituciones de investigación y desarrollo existentes. Existen enormes oportunidades en el acceso abierto a los planos técnicos de maquinaria agrícola, energía renovable y tecnologías de acceso al agua y saneamiento, que ya han sido desarrolladas por dichas instituciones de I+D. Abrir esos diseños podría ayudar a los actores locales a adquirir nuevos conocimientos, desarrollar sus propias herramientas e incluso ayudar a mejorar las que ya están disponibles.</td>
  </tr>
</table>
...
Fig. 8: RepRap 2.0, versión Mendel
...
En 2011 nació el grupo conocido como "Clone Wars" dentro de la comunidad RepRap, con el fin de documentar en español todo lo necesario para que cualquier persona pueda construir su propia impresora 3D.</td>
  </tr>
</table>
...
<table>
  <tr>
    <td>Box 6: Bomba de jeringa open source (OSSP)
...
Fig. 10. Una bomba de jeringa OS doble que cuesta 120 USD versus la versión comercial, de 5000 USD
Para este caso se realizó una valoración económica, obteniendo un valor de retorno de la inversión fluctuante entre $168,000 to $2.5 millones, para concluir que este método es sencillo y provee información para tomar decisiones. Resulta específicamente atractivo para organizaciones interesadas en maximizar el retorno de las inversiones públicas en tecnologías asociadas a la ciencia, medicina o educación.</td>
  </tr>
</table>
...
<table>
  <tr>
    <td>Box 7: Minipiano - Haciendo música con Arduino
...
Fig. 10. Las explicaciones siguen un criterio lógico que permite al estudiante ir probando si su desarrollo es o no exitoso.
...
Fig. 11. El funcionamiento del minipiano puede chequearse online vía Youtube. </td>
  </tr>
</table>
...
**Fig. 12: número de empresas OHW lanzadas por año (Berchon. 2013)**
...
Fig. 13: Limor Fried, premiada como emprendedora del año en 2012, fue tapa de la revista de tecnología WIRED
...
**Fig 14. Turbina eólica abierta de Tripalium, una fundación que promueve la energía eólica (Tripalium.org)**
